  ...
  <div class="content-wrapper">
    ...
    <div class="table-responsive">
      <table class="table">
        ...
        <tbody>
          <?php foreach(listMenu() as $listMenu) 
          {?>
          <tr>
            <td><?php echo $listMenu['title']; ?></td>
            <td><?php echo $listMenu['url']; ?></td>
            <td><?php echo $listMenu['sort']; ?></td>
            <td>
              
            <?php 
              if($listMenu['parent'] == 0)
              {
                echo "سر دسته";
              }
              else 
              {
                foreach(showTitle($listMenu['parent']) as $showTitle)
                {
                  echo $showTitle['title'];
                }
