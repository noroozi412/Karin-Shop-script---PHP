        ...
        <form role="form" method="post">
          <div class="card card-warning">
            ...
            <div class="card-body">
              ...
              {
                updateMenu($_GET['submit'],$_POST['data']);
              ...
              foreach (getMenu($_GET['submit']) as $getmenu ) {
              ...
              <form method="post" role="form">
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="<?php echo $getmenu['url']; ?>" name="data[url]" class="form-control" placeholder="وارد کردن اطلاعات ...">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <?php echo $getmenu['title']; ?>
                    <?php if($getmenu['parent']!=0){foreach(showMenu() as $parent){?>
